...
Examples:
  ...
  python reflexion_webshop_qwen25_3b.py --num-episodes 1 --num-trials 3 --max-steps 15

  # 200-env eval, 3 outer trials each, with JSONL + resume:
  python reflexion_webshop_qwen25_3b.py --num-episodes 200 --num-trials 3 \\
      --results reflexion_webshop_qwen25_3b_results.jsonl --resume
"""
...
RESULTS_LOG = "reflexion_webshop_qwen25_3b_results.txt"
PLOT_PREFIX = "reflexion_webshop_qwen25_3b_traj_hist"
...
def llm(prompt, stop=["\n"]):
    # Text-completion endpoint: the ReAct prompt ending in "Action:" is
...
def main():
    print("WebShop Reflexion (multi-trial ReAct + verbal self-reflection, vLLM Qwen2.5-3B)")
    args = parse_args()
