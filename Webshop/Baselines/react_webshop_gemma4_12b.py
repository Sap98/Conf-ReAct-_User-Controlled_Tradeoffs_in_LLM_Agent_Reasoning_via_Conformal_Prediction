...
# Only change from the original notebook: llm() now calls a local vLLM Gemma-4-12B-it
...
# ---------------------------------------------------------------------------
# LLM (local vLLM Gemma-4-12B-it, OpenAI-compatible /completions)
# ---------------------------------------------------------------------------
...
# NOT continue "Action:" literally — it degenerates (echoes/loops garbage like
# "100% 100% ..."). So use the chat endpoint with a system message that pins the
# output to exactly one action, then strip any "Action:"/"Action N:" prefix the
# model still adds. (Same fix web_rollback_gemma4_12b.py already applies.)
...
RESULTS_LOG = "react_webshop_gemma4_12b_traj_dist.txt"
PLOT_PREFIX = "react_webshop_gemma4_12b_traj_hist"
