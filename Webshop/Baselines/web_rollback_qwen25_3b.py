...
local vLLM Qwen2.5-3B completions endpoint (with logprobs for the
...
MODEL_NAME = "Qwen/Qwen2.5-3B"                              # For vllm use
client = OpenAI(base_url="http://10.5.18.73:8002/v1", api_key="EMPTY")
prob_threshold = 0.93
prob_list = []
logsum_list = []
PLOT_PREFIX = "web_rollback_qwen25_3b_traj_hist"
RESULTS_LOG = "web_rollback_qwen25_3b_traj_dist.txt"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--out_record_path", type=str, default="rollback_records_qwen25_3b.json", help="the file path for saving rollback records")
