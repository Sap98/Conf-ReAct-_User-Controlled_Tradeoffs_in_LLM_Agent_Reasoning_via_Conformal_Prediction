...
# Silence the "BertModel LOAD REPORT ... cls.* UNEXPECTED" table printed when
# loading bert-base-uncased as an encoder (the unused pretraining heads),
# and the "Loading weights: ...%" progress bar.
